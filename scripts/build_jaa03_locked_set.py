...
from career_automation.opportunity_calibration import evaluate_locked_set
...
envelope={'schema_version':'jaa03.locked-set.v1','frozen_at':'2026-07-20','stratification':{'sources':SOURCES,'role_families':ROLES,'geographies':GEOS},'records_hash':hashed(records),'records':records}
