...
def _authorized_release_inputs(
    ...
    *,
    ...
    route_adapter_id: str = "offline-test-adapter",
    route_adapter_version: str = "1",
    route_source_identity: str = "test:official-route-policy",
):
...
def _issued_release_inputs(tmp_path: Path, **route_options):
    values = _authorized_release_inputs(tmp_path, **route_options)
    (
        database,
        strategy,
        contact,
