...
- Authority: `giga-user/reports/JAA11_LIVE_CANARY_OPERATOR_AUTHORITY_2026-07-31.md`.
- Approved evidence: `giga-user/job-application-automation/candidate-evidence/approved_evidence_packet_2026-07-28.json`.
- Frozen snapshot: `Projects/job-application-automation-gutua-20260803-evidence/jaa11-acquisition-unaccepted-full/jaa11_ranked_snapshot.json`.
